...
export class RestClient {
  ...
  constructor(baseUrl: string, httpClient: HttpClient, connectionConfig: RequestConnectionConfig, advanceRequestConfig?: RequestAdvanceConfig) {
  ...
  get<R>(path: string, advanceRequestConfig?: RequestAdvanceConfig): Promise<RestResponse<R>> {
    return this.request('GET', path, advanceRequestConfig);
  }

  delete<R>(path: string, advanceRequestConfig?: RequestAdvanceConfig): Promise<RestResponse<R>> {
    return this.request('DELETE', path, advanceRequestConfig);
  }

  head<R>(path: string, advanceRequestConfig?: RequestAdvanceConfig): Promise<RestResponse<R>> {
    return this.request('HEAD', path, advanceRequestConfig);
  }

  options<R>(path: string, advanceRequestConfig?: RequestAdvanceConfig): Promise<RestResponse<R>> {
    return this.request('OPTIONS', path, advanceRequestConfig);
  }

  post<R>(path: string, advanceRequestConfig?: RequestAdvanceConfig): Promise<RestResponse<R>> {
    return this.request('POST', path, advanceRequestConfig);
  }

  put<R>(path: string, advanceRequestConfig?: RequestAdvanceConfig): Promise<RestResponse<R>> {
    return this.request('PUT', path, advanceRequestConfig);
  }

  patch<R>(path: string, advanceRequestConfig?: RequestAdvanceConfig): Promise<RestResponse<R>> {
    return this.request('PATCH', path, advanceRequestConfig);
  }

  request<R>(method: Method, path: string, advanceRequestConfig?: RequestAdvanceConfig): Promise<RestResponse<R>> {
